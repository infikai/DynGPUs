...
ACTIVE_WORKERS_FILE = "/mydata/Data/DynGPUs/exp/latency/custom_chk_vit/active_workers.txt"
...
GPU_FREE_TIMEOUT_SECONDS = 60  # --- NEW: Max time to wait for GPU memory to become free ---
